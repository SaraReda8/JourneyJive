...
import bgImage from '../../Assets/Images/sunset4.jpg'; // Import image
      ...
      <div className={styles.bookNow}>
        <div className={styles.bookNowImage}>
          <img
            ...
            loading="lazy"
            srcSet={`${image33} 1200w, ${image33} 800w, ${image33} 400w`} // Responsive images
          />
        </div>
        ...
        <div className={styles.bookNowImage}>
          <img
            ...
            className={`${styles.image} ${styles.animate}`}
            loading="lazy"
            srcSet={`${image34} 1200w, ${image34} 800w, ${image34} 400w`} // Responsive images
          />
        </div>
      </div>
      <div 
